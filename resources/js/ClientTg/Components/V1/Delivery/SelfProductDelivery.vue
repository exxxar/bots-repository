...
import CategoryList from "@/ClientTg/Components/V1/Shop/Categories/CategoryInlineList.vue";
    ...
    <div v-touch:swipe.left="doSwipeLeft"
        ...
        <div class="card card-style">
            <div class="content">
                ...
                <div
                    class="tab-controls mb-2 tabs-round tab-animated tabs-medium tabs-rounded d-flex justify-content-between"
                >
                    <a href="javascript:void(0)"
                       class="w-100"
                       @click="tab=0"
                       v-bind:class="{'bg-blue2-dark color-white no-click':tab===0}">Категории</a>
                    <a href="javascript:void(0)"
                       class="w-100"
                       @click="tab=1"
                       v-bind:class="{'bg-blue2-dark color-white no-click':tab===1}"
                    >Товары</a>
                    <a
                        v-if="cartProducts.length>0"
                        v-bind:class="{'bg-blue2-dark color-white no-click':tab===2}"
                        class="w-100"
                        @click="tab=2"
                ...
                <div v-show="tab===2">
                    <form
                        ...
                        v-on:submit.prevent="startCheckout" v-if="cartProducts.length>0">
                        ...
                        <div class="row mb-0" v-if="getSelf">
                            ...
                            <div class="col-6 text-left"
                                 v-if="getSelf.cashBack&&settings.min_price_for_cashback<cartTotalPrice"><h4>
                                Использовать
                                CashBack</h4></div>

                            <div class="col-6 text-right"
                                 v-if="getSelf.cashBack&&settings.min_price_for_cashback<cartTotalPrice">
                        ...
                        <div class="custom-control ios-switch ios-switch-icon my-3">
                            ...
                            <label class="custom-control-label pl-5" for="toggle-need-pickup"
                                   v-if="!deliveryForm.need_pickup">Доставка</label>
                            <label class="custom-control-label pl-5" for="toggle-need-pickup"
                                   v-if="deliveryForm.need_pickup">Самовывоз</label>
                        ...
                        <div class="custom-control ios-switch ios-switch-icon my-3">
                            ...
                            <label class="custom-control-label pl-5" for="toggle-when-ready"
                                   v-if="!deliveryForm.when_ready">Ко
                                времени</label>
                            <label class="custom-control-label pl-5" for="toggle-when-ready"
                                   v-if="deliveryForm.when_ready">По
                                готовности</label>
