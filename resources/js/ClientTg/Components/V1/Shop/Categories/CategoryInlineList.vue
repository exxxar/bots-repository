<script setup>
import CategoryItem from "@/ClientTg/Components/V1/Shop/Categories/CategoryItem.vue";
...
<template>
    <div v-if="categories" class="d-flex flex-wrap">
        ...
        <a
            ...
            class="m-0 mb-2 badge mr-2 bg-green2-dark  rounded-l font-14 category-badge p-3">
