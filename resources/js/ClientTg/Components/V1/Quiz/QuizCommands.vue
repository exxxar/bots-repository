<script setup>
import QuizCommandForm from "@/ClientTg/Components/V1/Quiz/QuizCommandForm.vue";
import QuizCommandList from "@/ClientTg/Components/V1/Quiz/QuizCommandList.vue";
</script>
<template>
