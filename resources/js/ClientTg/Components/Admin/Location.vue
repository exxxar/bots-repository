<template>
    ...
    <form v-on:submit.prevent="submitLocation">
        ...
        <h6>Геопозиция</h6>
        <p class="mb-2" @click="openMapModal"><i class="fa-solid fa-location-dot mr-2"></i> Открыть карту</p>
...
export default {
    ...
    mounted() {
        ...
        window.addEventListener("select-map-coords", (e) => {
           this.locationForm.lat =  e.detail.param.lat
           this.locationForm.lon =  e.detail.param.lon
        } );
    },
    methods: {
        openMapModal(){
