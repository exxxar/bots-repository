...
export default {
    ...
    computed: {
        ...
        filteredProviders(){
            ...
            return this.providers.filter(item=>item.bankName.indexOf(this.search)!==-1)
        }
    },
    mounted() {
