...
<template>
        ...
        <div class="container my-3 g-2" v-if="self">
            ...
            <p class="alert alert-light">
                Уважаемый клиент, ваш отзыв будет опубликован в нашем канале <strong class="fw-bold text-primary">анонимно</strong>, ваши данные увидит только администрация проекта, заранее благодарим за обратную связь!
            </p>
