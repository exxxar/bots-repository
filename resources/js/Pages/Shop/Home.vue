<template>
        ...
        <div class="page-title page-title-large">
            <h2 data-username="Enabled!" class="greeting-text">Good morning,<br>Enabled!</h2>
        ...
        <div class="card header-card shape-rounded" data-card-height="140" style="height: 140px;">
        ...
        <div class="double-slider owl-carousel owl-no-dots owl-loaded owl-drag">
            ...
            <div class="owl-stage-outer">
                <div class="owl-stage"
                     style="transform: translate3d(-325px, 0px, 0px); transition: all 0s ease 0s; width: 1341px; padding-left: 20px; padding-right: 20px;">
                    <div class="owl-item cloned" style="width: 142.6px; margin-right: 20px;">
                        <div class="item bg-theme pb-3 rounded-m shadow-l">
                            <div data-card-height="200" class="card mb-3 bg-13" style="height: 200px;">
                    ...
                    <div class="owl-item cloned" style="width: 142.6px; margin-right: 20px;">
                        <div class="item bg-theme pb-3 rounded-m shadow-l">
                            <div data-card-height="200" class="card mb-3 bg-14" style="height: 200px;">
                                <div class="card-bottom">
                    ...
                    <div class="owl-item active" style="width: 142.6px; margin-right: 20px;">
                        <div class="item bg-theme pb-3 rounded-m shadow-l">
                            <div data-card-height="200" class="card mb-3 bg-11" style="height: 200px;">
                                <div class="card-bottom">
                    ...
                    <div class="owl-item active" style="width: 142.6px; margin-right: 20px;">
                        <div class="item bg-theme pb-3 rounded-m shadow-l">
                            <div data-card-height="200" class="card mb-3 bg-12" style="height: 200px;">
                                <div class="card-bottom">
                    ...
                    <div class="owl-item" style="width: 142.6px; margin-right: 20px;">
                        <div class="item bg-theme pb-3 rounded-m shadow-l">
                            <div data-card-height="200" class="card mb-3 bg-13" style="height: 200px;">
                                <div class="card-bottom">
                                    <h5 class="color-white text-center pr-2 pb-2">DuoDrawer</h5>
                    ...
                    <div class="row mt-3 pt-1 mb-3">
                        <div class="col-6">
                            <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" viewBox="0 0 24 24"
                                 ...
                                 stroke-linejoin="round" class="feather feather-globe float-left ml-3 mr-3"
                                 data-feather-line="1" data-feather-size="35" data-feather-color="blue2-dark"
                                 data-feather-bg="blue2-fade-light" style="width: 35px; height: 35px;">
                        ...
                        <div class="col-6 pl-0">
                            <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" viewBox="0 0 24 24"
                                 fill="none" stroke="currentColor" stroke-width="1" stroke-linecap="round"
                                 stroke-linejoin="round" class="feather feather-smartphone float-left ml-3 mr-3"
                                 data-feather-line="1" data-feather-size="35" data-feather-color="dark2-dark"
                                 data-feather-bg="dark2-fade-light" style="width: 35px; height: 35px;">
                                <rect x="5" y="2" width="14" height="20" rx="2" ry="2"></rect>
                                <line x1="12" y1="18" x2="12.01" y2="18"></line>
                            </svg>
                            <h5 class="color-black float-left font-13 font-500 line-height-s pb-3 mb-3">24/7<br>Support
                            </h5>
                        </div>
                        <div class="col-6">
                            <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" viewBox="0 0 24 24"
                                 fill="none" stroke="currentColor" stroke-width="1" stroke-linecap="round"
                                 stroke-linejoin="round" class="feather feather-star float-left ml-3 mr-3"
                                 data-feather-line="1" data-feather-size="35" data-feather-color="yellow1-dark"
                                 data-feather-bg="yellow1-fade-light" style="width: 35px; height: 35px;">
                                <polygon
                        ...
                        <div class="col-6 pl-0">
                            <svg xmlns="http://www.w3.org/2000/svg" width="33" height="33" viewBox="0 0 24 24"
                                 fill="none" stroke="currentColor" stroke-width="1" stroke-linecap="round"
                                 stroke-linejoin="round" class="feather feather-truck float-left ml-3 mr-3"
                                 data-feather-line="1" data-feather-size="33" data-feather-color="green1-dark"
                                 data-feather-bg="green1-fade-light" style="width: 33px; height: 33px;">
        ...
        <div class="double-slider owl-carousel owl-no-dots owl-loaded owl-drag">
            ...
            <div class="owl-stage-outer">
                <div class="owl-stage"
                    ...
                    <div class="owl-item cloned" style="width: 142.6px; margin-right: 20px;">
                        <div class="item bg-theme pb-3 rounded-m shadow-l">
                            <div data-card-height="200" class="card mb-3 bg-16" style="height: 200px;">
                                <div class="card-bottom">
                                    <h5 class="color-white text-center pr-2 pb-2">DuoDrawer</h5>
                                </div>
                                <div class="card-overlay bg-gradient"></div>
                    ...
                    <div class="owl-item cloned" style="width: 142.6px; margin-right: 20px;">
                        <div class="item bg-theme pb-3 rounded-m shadow-l">
                            <div data-card-height="200" class="card mb-3 bg-17" style="height: 200px;">
                                <div class="card-bottom">
                                    <h5 class="color-white text-center pr-2 pb-2">EazyMobile</h5>
                                </div>
                                <div class="card-overlay bg-gradient"></div>
                    ...
                    <div class="owl-item active" style="width: 142.6px; margin-right: 20px;">
                        <div class="item bg-theme pb-3 rounded-m shadow-l">
                            <div data-card-height="200" class="card mb-3 bg-15" style="height: 200px;">
                                <div class="card-bottom">
                                    <h5 class="color-white text-center pr-2 pb-2">Appkit</h5>
                                </div>
                                <div class="card-overlay bg-gradient"></div>
                ...
                <div class="card rounded-m shadow-xl mb-0">
                    <div class="content">
                        <div class="d-flex pb-3">
                            <div class="pr-3">
                                <h5 class="font-14 font-600 opacity-80 pb-2">Appkit Mobile Website Template and
                                    PWA. </h5>
                        ...
                        <div class="d-flex pb-2">
                            <div class="pr-3">
                                <h5 class="font-14 font-600 opacity-80 pb-2">6 Months Hands on Support Included in
                                    Pack. </h5>
                                <h1 class="font-24 font-700 color-green1-dark">$0<sup
                                    class="font-15 opacity-50">.00</sup></h1>
                            </div>
                            <div class="ml-auto">
                        ...
                        <a href="#" class="btn btn-full btn-m bg-highlight font-700 text-uppercase rounded-m shadow-xl">
                            Add to Cart</a>
        ...
        <a href="#" data-card-height="80" class="card card-style mb-3" style="height: 80px;">
        ...
        <a href="#" data-card-height="80" class="card card-style mb-4" style="height: 80px;">
            <div class="card-center">
