    ...
    <div class="row mb-2" v-if="need_reset&&!editor">
        <div class="col-12">
            <button
                type="button"
                @click="resetForm"
                class="btn btn-outline-danger">Новый клиент \ очистка формы</button>
        </div>
    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-12 mb-3">
                        ...
                        <select type="text" class="form-control"
                            ...
                            <option :value="code.id" v-for="(code, index) in vat_codes">{{code.title || 'Не указано'}}</option>
                        </select>
                    </div>
                    ...
                    <div class="col-12 ">
                        <div class="card mb-3">
                            <div class="card-header">
                                <h6>Логотип компании <span class="badge rounded-pill text-bg-warning m-0">Желательно</span></h6>
                            </div>
