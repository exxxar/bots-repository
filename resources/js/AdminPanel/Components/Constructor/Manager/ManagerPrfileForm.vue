...
-->
    ...
    <div class="container shadow-lg border mt-5 mb-5" v-if="botUser">
        <div class="row">
            <div class="col-md-3 border-right bg-primary" v-if="botUser.manager">
                <div class="d-flex flex-column align-items-center text-center p-3 py-5">
                    <img class="rounded-circle mt-5" style="width:150px; height:150px; object-fit:cover;"
                         v-lazy="'../images/manager.png'">
                    <a href="javascript:void(0)"
                    ...
                    <h6 class="my-3">Вам доступны следующие возможности:</h6>
                    <ol class="text-left list-group list-group-numbered">
                        ...
                        <li class="list-group-item">Использование ресурсов компании для привлечения клиентов: маркетологи, дизайнеры,
                            smm-специалисты,
                            программисты
                        </li>
                    ...
                    <ol class="text-left list-group list-group-numbered">
                        ...
                        <li class="list-group-item">Получение бонусных доходов с реферальной программы 1, 2 и 3 уровня: ваши друзья работают, а вы
            ...
            <div
                v-bind:class="{'col-md-6':!botUser.manager}"
                    ...
                    <div class="mt-5 text-center">
                        ...
                        <div class="form-check d-flex justify-content-center">
                            <input class="form-check-input mr-2"
                                   v-model="confirm"
                                   type="checkbox" value="" id="accept-rules">
                        ...
                        <button class="btn btn-primary profile-button px-5" type="button">Сохранить профиль</button>
                    </div>
                </div>
            </div>
            <div class="col-md-4"  v-bind:class="{'col-md-6':!botUser.manager}">
                <div class="p-3 py-5">
                    <div class="d-flex justify-content-between align-items-center experience">
                        <span>Ваши навыки</span>
                        <span class="border px-3 p-1 add-experience" @click="add('skills')"><i class="fa fa-plus mr-2"></i>Добавить</span>
                    </div><br>

                    <div class="row">

                    <div class="col-md-12" v-for="(item, index) in managerForm.skills">
                        <div class="input-style input-style-2 position-relative">
                    ...
                    <div class="d-flex justify-content-between align-items-center experience">
                        <span>Ваши сильные стороны</span>
                        <span class="border px-3 p-1 add-experience" @click="add('strengths')"><i class="fa fa-plus mr-2"></i>Добавить</span>
                    </div><br>
                    <div class="row">
                        <div class="col-12">
                            <h6 class="text-center">Ваши сильные стороны</h6>
                    ...
                    <div class="d-flex justify-content-between align-items-center experience">
                        <span>Ваши слабые стороны</span>
                        <span class="border px-3 p-1 add-experience" @click="add('weaknesses')"><i class="fa fa-plus mr-2"></i>Добавить</span>
                    </div><br>
                    <div class="row">
                        <div class="col-12">
                            <p class="mb-3"><em>Слабые стороны есть у всех! Нам нужно понимать в чем Вас стоит прокачать и в
