        ...
        <div class="col-12">
            <div class="input-group mb-3">
                <input type="search" class="form-control "
                       ...
                       aria-label="Поиск рассылки"
                       v-model="search"
                       aria-describedby="queue-search-queue">
        ...
        <div class="col-12">
            <table class="table" v-if="queues.length>0">
                ...
                <tr>
                    ...
                    <th scope="col" class="cursor-pointer" @click="loadAndOrder('content')">Содержимое</th>
                    ...
                    <th scope="col" class="cursor-pointer" @click="loadAndOrder('sent_at')">Отправлено в</th>
                ...
                <tr v-for="(queue, index) in queues"
                    ...
                    <td @click="selectEvent(queue)">{{ queue.content || 'Не указано' }}
                    </td>
                    ...
                    <td>{{ $filters.currentFull(queue.updated_at) }}</td>
                    <td>
