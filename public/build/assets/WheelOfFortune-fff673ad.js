...
.wheel .content.horizontal-content span[data-v-2d0cf945] {
  display: block;
  transform: rotate(270deg);
}`;W(D);p.render=B;p.__scopeId="data-v-2d0cf945";const $={key:0,class:"row"},O={key:0,class:"col-12 mb-2"},V={class:"card"},N={class:"card-body"},R=["innerHTML"],T={class:"col-12 mb-2"},j={key:1,class:"col-12 d-flex justify-content-center align-items-center",style:{"padding-top":"100px"}},E=n("div",null,"Поехали",-1),L={key:2,class:"col-12 p-5"},M={key:0,class:"alert alert-success mb-2",role:"alert"},U=n("h6",{class:"text-center"},"Укажите своё имя, как к Вам может обращаться менеджер?",-1),H={class:"input-group mb-3"},P={class:"col-12"},K=n("h6",{class:"text-center"},"Введите свой номер телефона чтобы наш менеджер мог связаться с Вами!",-1),Y={class:"input-group mb-3"},J=n("button",{class:"btn btn-outline-primary p-3 w-100"}," Получить выигрышь ",-1),X={class:"col-12 p-5 mt-2"},G={key:1,class:"row"},Q={class:"col-12"},Z={class:"w-100",style:{"object-fit":"cover"},alt:""},ee={name:"App",components:{Roulette:p},data(){return{rouletteKey:0,played:!1,action:null,winForm:{win:null,name:null,phone:null},items:[]}},computed:{tg(){return window.Telegram.WebApp},tgUserId(){return JSON.parse(new URLSearchParams(window.Telegram.WebApp.initData).get("user")).id||null}},mounted(){this.prepare().then(()=>{this.played=this.action.completed_at!=null;let e=1;this.items=[],this.wheels.forEach(t=>{this.items.push({id:e,name:t.value,htmlContent:t.value,textColor:"",background:""}),e++})})},methods:{prepare(){return this.$store.dispatch("wheelOfFortunePrepare",{prepareForm:{telegram_chat_id:this.tgUserId},bodDomain:this.bot.bot_domain}).then(e=>{this.action=e})},submit(){let e=new FormData;Object.keys(this.winForm).forEach(t=>{const a=this.winForm[t]||"";typeof a=="object"?e.append(t,JSON.stringify(a)):e.append(t,a)}),e.append("telegram_chat_id",this.tgUserId),this.$store.dispatch("wheelOfFortuneWin",{winForm:e,bodDomain:this.bot.bot_domain}).then(t=>{this.winForm={win:null,name:null,phone:null},this.$notify({title:"Колесо фортуны",text:"Вы успешно приняли участие в розыгрыше! Наш менеджер свяжется с вами для дальнейших инструкций.",type:"success"})}).catch(t=>{})},closeWheel(){this.tg.close()},launchWheel(){this.rouletteKey+=1,setTimeout(()=>this.$refs.wheel.launchWheel(),0)},wheelStartedCallback(){console.log("wheelStartedCallback")},wheelEndedCallback(e){console.log(e),this.winForm.win=e}}},ne=Object.assign(ee,{props:{bot:Object,wheels:Array,rules:String},setup(e){return(t,a)=>{const s=g("mask"),r=g("lazy");return t.action?(o(),i("div",$,[e.rules?(o(),i("div",O,[n("div",V,[n("div",N,[n("p",{innerHTML:e.rules},null,8,R)])])])):d("",!0),n("div",T,[n("p",null,[b("Ваши попытки: "),n("strong",null,f(t.action.current_attempts||0),1),b(" из "),n("strong",null,f(t.action.max_attempts||1),1)])]),t.played?d("",!0):(o(),i("div",j,[(o(),_(I(p),{ref:"wheel",size:"300",key:t.rouletteKey,items:t.items,"centered-indicator":"","indicator-position":"top","display-shadow":"","display-border":"","base-display":"","base-display-indicator":"","base-background":"orange","base-display-shadow":"",easing:"bounce",onWheelStart:t.wheelStartedCallback,onWheelEnd:t.wheelEndedCallback,onClick:t.launchWheel},{baseContent:z(()=>[E]),_:1},8,["items","onWheelStart","onWheelEnd","onClick"]))])),t.played?d("",!0):(o(),i("div",L,[t.winForm.win?(o(),i("div",M,[n("p",null,"Вы выиграли - "+f(t.winForm.win.htmlContent)+".",1)])):d("",!0),n("form",{onSubmit:a[2]||(a[2]=(...l)=>t.submit&&t.submit(...l))},[U,n("div",H,[m(n("input",{type:"text",class:"form-control text-center p-3",placeholder:"Петров Петр Семенович","aria-label":"winForm-name","onUpdate:modelValue":a[0]||(a[0]=l=>t.winForm.name=l),"aria-describedby":"winForm-name",required:""},null,512),[[w,t.winForm.name]])]),n("div",P,[K,n("div",Y,[m(n("input",{type:"text",class:"form-control p-3 text-center","onUpdate:modelValue":a[1]||(a[1]=l=>t.winForm.phone=l),placeholder:"+7(000)000-00-00","aria-label":"winForm-phone","aria-describedby":"vipForm-phone",required:""},null,512),[[s,"+7(###)###-##-##"],[w,t.winForm.phone]])]),J])],32)])),n("div",X,[n("button",{onClick:a[3]||(a[3]=(...l)=>t.closeWheel&&t.closeWheel(...l)),type:"button",class:"btn btn-outline-info p-2"}," Вернуться в бота ")])])):(o(),i("div",G,[n("div",Q,[m(n("img",Z,null,512),[[r,"/images/load.gif"]])])]))}}});export{ne as default};
