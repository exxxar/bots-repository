...
.wheel .content.horizontal-content span[data-v-2d0cf945] {
  display: block;
  transform: rotate(270deg);
}`;W(D);f.render=B;f.__scopeId="data-v-2d0cf945";const $={class:"container"},O={key:0,class:"row"},V={key:0,class:"col-12 mb-2 mt-2"},N={class:"card"},R={class:"card-body"},j={class:"col-12 mb-2 mt-2"},E={key:0,style:{"text-align":"center","font-size":"larger"}},T={key:1,style:{"text-align":"center","font-size":"larger"}},L={key:1,class:"col-12 d-flex justify-content-center align-items-center"},P=n("div",null,"Поехали",-1),M={key:2,class:"col-12 p-2"},U={class:"alert alert-info mb-2",role:"alert"},K=n("h6",{class:"text-center"},"Укажите своё имя, как к Вам может обращаться менеджер?",-1),Y={class:"input-group mb-2"},H={class:"col-12"},J=n("h6",{class:"text-center"},"Введите свой номер телефона чтобы наш менеджер мог связаться с Вами!",-1),X={class:"input-group mb-2"},G=n("button",{class:"btn btn-outline-primary p-3 w-100"}," Получить выигрышь ",-1),Q={class:"col-12 p-2"},Z={key:1,class:"row"},ee={class:"col-12"},te={class:"w-100",style:{"object-fit":"cover"},alt:""},ne={name:"App",components:{Roulette:f},data(){return{rouletteKey:0,action:null,winForm:{win:null,name:null,phone:null},items:[]}},computed:{canPlay(){return this.action.current_attempts<this.action.max_attempts},tg(){return window.Telegram.WebApp},tgUserId(){return JSON.parse(new URLSearchParams(window.Telegram.WebApp.initData).get("user")).id||null}},mounted(){this.prepare().then(()=>{let t=1;this.items=[],this.wheels.forEach(e=>{this.items.push({id:t,name:e.value,htmlContent:e.value,textColor:"",background:""}),t++})})},methods:{prepare(){return this.$store.dispatch("wheelOfFortunePrepare",{prepareForm:{telegram_chat_id:this.tgUserId},bodDomain:this.bot.bot_domain}).then(t=>{this.action=t})},submit(){let t=new FormData;Object.keys(this.winForm).forEach(e=>{const a=this.winForm[e]||"";typeof a=="object"?t.append(e,JSON.stringify(a)):t.append(e,a)}),t.append("telegram_chat_id",this.tgUserId),this.$store.dispatch("wheelOfFortuneWin",{winForm:t,bodDomain:this.bot.bot_domain}).then(e=>{this.winForm={win:null,name:null,phone:null},this.$notify({title:"Колесо фортуны",text:"Вы успешно приняли участие в розыгрыше! Наш менеджер свяжется с вами для дальнейших инструкций.",type:"success"}),this.prepare()}).catch(e=>{})},closeWheel(){this.tg.close()},launchWheel(){this.rouletteKey+=1,setTimeout(()=>this.$refs.wheel.launchWheel(),0)},wheelStartedCallback(){console.log("wheelStartedCallback")},wheelEndedCallback(t){this.winForm.win=t.id}}},ie=Object.assign(ne,{props:{bot:Object,wheels:Array,rules:String},setup(t){return(e,a)=>{const s=g("mask"),r=g("lazy");return i(),o("div",$,[e.action?(i(),o("div",O,[t.rules?(i(),o("div",V,[n("div",N,[n("div",R,[n("p",null,p(t.rules),1)])])])):c("",!0),n("div",j,[e.canPlay?(i(),o("p",E,[b("Ваши попытки: "),n("strong",null,p(e.action.current_attempts||0),1),b(" из "),n("strong",null,p(e.action.max_attempts||1),1)])):(i(),o("p",T,"Вы израсходовали все ваши попытки"))]),e.canPlay&&e.winForm.win==null?(i(),o("div",L,[(i(),C(F(f),{ref:"wheel",size:"300",key:e.rouletteKey,items:e.items,"centered-indicator":"","indicator-position":"top","display-shadow":"","display-border":"","base-display":"","base-display-indicator":"","base-background":"orange","base-display-shadow":"",easing:"bounce",onWheelStart:e.wheelStartedCallback,onWheelEnd:e.wheelEndedCallback,onClick:e.launchWheel},{baseContent:z(()=>[P]),_:1},8,["items","onWheelStart","onWheelEnd","onClick"]))])):c("",!0),e.canPlay&&e.winForm.win?(i(),o("div",M,[n("div",U,[n("p",null,"Вы выиграли - "+p(e.winForm.win)+".",1)]),n("form",{onSubmit:a[2]||(a[2]=(...l)=>e.submit&&e.submit(...l))},[K,n("div",Y,[m(n("input",{type:"text",class:"form-control text-center p-3",placeholder:"Петров Петр Семенович","aria-label":"winForm-name","onUpdate:modelValue":a[0]||(a[0]=l=>e.winForm.name=l),"aria-describedby":"winForm-name",required:""},null,512),[[w,e.winForm.name]])]),n("div",H,[J,n("div",X,[m(n("input",{type:"text",class:"form-control p-3 text-center","onUpdate:modelValue":a[1]||(a[1]=l=>e.winForm.phone=l),placeholder:"+7(000)000-00-00","aria-label":"winForm-phone","aria-describedby":"vipForm-phone",required:""},null,512),[[s,"+7(###)###-##-##"],[w,e.winForm.phone]])]),G])],32)])):c("",!0),n("div",Q,[n("button",{onClick:a[3]||(a[3]=(...l)=>e.closeWheel&&e.closeWheel(...l)),type:"button",class:"btn btn-outline-success p-3 w-100"}," Вернуться в бота ")])])):(i(),o("div",Z,[n("div",ee,[m(n("img",te,null,512),[[r,"/images/load.gif"]])])]))])}}});export{ie as default};
